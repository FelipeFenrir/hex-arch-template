...
public final class ServiceProduct implements Product {
    private final Id id;
    private final String sourceId;
    private final String name;
    private final String surname;
    private final String description;
    private final ProductKind productKind = ProductKind.SERVICE;
    private final ProductStatus productStatus;
    private final Set<ProductCapability> productCapabilities;
    private final Instant createdAt;
    private final Instant updatedAt;

    private ServiceProduct(final Id id, final String sourceId, final String name, final String surname,
    ...
    public static ServiceProduct createNew(final Id id, final String sourceId, final String name, final String surname,
                                          final String description, Set<ProductCapability> productCapabilities) {
        Instant now = Instant.now();
        return new ServiceProduct(id, sourceId, name, surname, description, ProductStatus.DRAFT,
