...
public final class BundleProduct implements Product {
    private final Id id;
    private final String sourceId;
    private final String name;
    private final String surname;
    private final String description;
    private final ProductKind productKind = ProductKind.BUNDLE;
    private final ProductStatus productStatus;
    private final Set<ProductCapability> productCapabilities;
    private final Instant createdAt;
    private final Instant updatedAt;

    private BundleProduct(final Id id, final String sourceId, final String name, final String surname,
    ...
    public static BundleProduct createNew(final String sourceId, final String name, final String surname,
                                          final String description, Set<ProductCapability> productCapabilities) {
        Instant now = Instant.now();
        return new BundleProduct(Id.withoutId(), sourceId, name, surname, description, ProductStatus.DRAFT,
                productCapabilities, now, now);
    }

    public static BundleProduct rehydrate(final Id id, final String sourceId, final String name, final String surname,
                                          final String description, final ProductStatus productStatus,
                                          final Set<ProductCapability> productCapabilities, final Instant createdAt,
                                          final Instant updatedAt) {
        return new BundleProduct(id, sourceId, name, surname, description, productStatus, productCapabilities, createdAt,
                updatedAt);
    }

    public static BundleProduct rehydrate(final String id, final String sourceId, final String name,
