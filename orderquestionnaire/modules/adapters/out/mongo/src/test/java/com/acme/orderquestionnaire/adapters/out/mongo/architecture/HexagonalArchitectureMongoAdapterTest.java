package com.acme.orderquestionnaire.adapters.out.mongo.architecture;
...
@ArchitectureTest
@DisplayName("Hexagonal Architecture: Mongo Adapter")
@AnalyzeClasses(
        packages = "com.acme.orderquestionnaire.adapters.out.mongo",
        importOptions = ImportOption.DoNotIncludeTests.class
)
class HexagonalArchitectureMongoAdapterTest {

    @ArchTest
    static final ArchRule adapters_should_not_depend_on_bootstrap =
            noClasses().that().resideInAPackage("..adapters.out.mongo..")
