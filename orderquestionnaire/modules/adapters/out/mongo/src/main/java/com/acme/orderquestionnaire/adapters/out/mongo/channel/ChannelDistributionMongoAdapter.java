...
@Component("channelDistributionMongoAdapter")
@OutputAdapter
public class ChannelDistributionMongoAdapter implements ChannelDistributionOutPort {

    private final ChannelDistributionRepository channelDistributionRepository;

    public ChannelDistributionMongoAdapter(ChannelDistributionRepository channelDistributionRepository) {
